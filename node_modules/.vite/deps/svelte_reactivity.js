import {
  increment
} from "./chunk-65NVNB4R.js";
import "./chunk-4RS54O63.js";
import "./chunk-PMLYTPVT.js";
import {
  DESTROYED,
  DEV,
  derived,
...
var _SvelteMap = class _SvelteMap extends Map {
  ...
  set(key, value) {
    ...
    if (s === void 0) {
      ...
      increment(s);
      if (s.reactions === null && version.reactions !== null || s.reactions !== null && version.reactions === null) {
        increment(version);
      }
    }
    return res;
